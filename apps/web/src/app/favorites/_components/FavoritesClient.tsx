...
/**
 * 收藏夹列表由 Server Component 取好后经 fallback 注入 SWR。
 * 夹内条目是条件请求（folderId 为 null 时不发），因此服务端只注入 /me/favorites。
 */
export function FavoritesClient({ fallback }: { fallback: Record<string, unknown> }) {
  return (
