...
export function VideoCard({ item, eager = false, index = 0 }: { item: FeedItem; eager?: boolean; index?: number }) {
  ...
  return (
    <motion.div
      ...
      transition={reduced ? { duration: 0 } : { duration: DURATION_BASE, ease: EASE_OUT, delay }}
    >
